# 静電容量式土壌水分センサ基板
## 概要
このセンサは静電容量式の土壌水分センサです。この基板だけで土壌水分の検出はできませんので、別売の[静電容量式レインセンサ検出基板](https://naoto64.github.io/Rain-Capacitance-Sensor/)を使用します。（商品名がレインセンサですが土壌水分センサと共通です。）

地中の水分量に応じて、端子間の静電容量が変化します。その静電容量を読み取ることで、土壌水分を検出することができます。 このセンサは従来の抵抗式とは違い、電極が腐食しないため、長時間の屋外使用でも耐久性が上がります。 また、基板にIC等の電子部品が無いため、水による故障が起きにくくなります。
...
検出基板のボリュームでしきい値の調整をして下さい。

## 購入
この製品は以下のサイトから購入できます。  
[スイッチサイエンス - 静電容量式土壌水分センサ基板](https://www.switch-science.com/products/9377 "静電容量式土壌水分センサ基板")
